...
{
    [Area("Backoffice")]
    public class PendingRoomController : BaseController 
    {
        public PendingRoomController(ApplicationDbContext applicationDbContext):base(applicationDbContext)
        {
        ...
        public async Task<IActionResult> Index( string searchString) 
        {
            ...
            if ( !String.IsNullOrEmpty(searchString)) {
                rooms = await ApplicationDbContext.Rooms
                    .Where(o => o.Name.Contains(searchString) && o.RoomStateId == 3 )
                    .OrderBy(o => o.Name)
                    .Include(u => u.User)
                    .ToListAsync();
            } else {
                rooms = await ApplicationDbContext.Rooms
                    .Where(o => o.RoomStateId == 3)
                    .OrderBy(o => o.Name)
                    .Include(u => u.User)
                    .ToListAsync();
            }
